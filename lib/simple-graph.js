...
function simpleGraph(elem, data, options) {
  var cx = 600, cy = 300;
  ...
  function graph(selection) {
    ...
    function generateDataPoints(indexed_data) {
      options.datacount = indexed_data.length;
      options.xtic = options.xrange / options.datacount;
      options.ytic = options.yrange / options.datacount;
      points = indexed_data.map(function(value, i) {
        return { x: i, y: value };
      });
    }
    ...
    graph.generateDataPoints = generateDataPoints;
