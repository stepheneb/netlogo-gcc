...
window.onload=function() {
  ...
  function isAppletReady() {
    ...
    if(applet.ready) {
      ...
      //   nl_panel:      org.nlogo.lite.Applet object
      //   nl_workspace:  org.nlogo.lite.LiteWorkspace
      //   nl_world:      org.nlogo.agent.World
      //   nl_program:    org.nlogo.api.Program
      //   nl_observer:
  ...
  run_button.onclick = function() {
    nl_panel.command("execute");
  };

  reset_button.onclick = function() {
    nl_panel.command("startup");
  };

  watch_sunray_button.onclick = function() {
    nl_panel.command("watch one-of sunrays with [ycor > (max-pycor / 2 ) and heading > 90 ]");
  };
